//
//  TJHButtonCountingDownManager.m
//  iBreezeeNewest
//
...
@interface TJHButtonCountingDownManager ()
...
@implementation TJHButtonCountingDownManager
...
+ (instancetype)defaultManager {
    ...
    if ([instance class] != [TJHButtonCountingDownManager class]) {
